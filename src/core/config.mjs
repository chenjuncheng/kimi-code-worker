...
export const DEFAULT_PROTOCOL_UNSETTLED_AFTER_MS = positiveEnvMs("KIMI_CODE_WORKER_PROTOCOL_UNSETTLED_AFTER_MS", 60 * 1000);
...
export const TOOL_CALL_PART_BURST_MIN = positiveEnvNumber("KIMI_CODE_WORKER_TOOL_CALL_PART_BURST_MIN", 12);
